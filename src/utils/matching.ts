import type { ScrapedSong, SpotifyTrackSummary, TrackMatch } from '../types/index.js';
...
export class SongMatcher {
  static score(song: ScrapedSong, track: SpotifyTrackSummary): TrackMatch {
    ...
    if (track.durationMs && track.durationMs > 0) {
      ...
      if (minutes < 1.5 || minutes > 7) durationFactor = 0.98;
    }
