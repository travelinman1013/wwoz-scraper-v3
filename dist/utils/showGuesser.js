...
function weekdayInCentral(date) {
...
export class ShowGuesser {
     ...
     */
    guessShowFromLocalParts(playedDate, playedTime, fallbackTimestamp) {
        ...
        const fbDay = weekdayInCentral(fb);
        const fbHHMM = hhmmInCentral(fb);
